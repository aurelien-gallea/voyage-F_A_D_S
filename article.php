    ...
    ?>
      <div class="bg-gray-700">
         ...
         <div class="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <div class="flex flex-row items-center justify-between mb-2">
               <h5 class="text-sm font-bold tracking-tight text-gray-900 dark:text-white"> 
                ...
                <!-- Bouton Modifier -->
        <?php if ($is_author) { ?>
            <button data-modal-target="staticModal2_<?= $i ?>" data-modal-toggle="staticModal2_<?= $i ?>" class="inline-flex items-center py-1 px-2 text-white bg-red-900 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
        ...
        <?php } ?>
             ...
             <!-- Bouton Supprimer -->
        <?php if ($is_author) { ?>
            <button data-modal-target="popup-modal_<?= $i ?>" data-modal-toggle="popup-modal_<?= $i ?>" data-comment-id="<?= $commentaire['id'] ?>" class="inline-flex items-center py-1 px-2 text-white bg-red-900 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                Supprimer
            </button>
        <?php } ?>
            ...
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="popup-modal_">
            ...
            <div class="p-6 text-center">
                ...
                <button type="submit" value="<?= $commentaire['id'] ?>" name="suppr_commentaire" data-modal-hide="popup-modal_" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
  OUI! 
</button>

<script>
  // const deleteBtns = document.querySelectorAll('[data-comment-id]');
  // deleteBtns.forEach(btn => {
  //   btn.addEventListener('click', (event) => {
  //     const commentId = event.currentTarget.getAttribute('data-comment-id');
  //     const confirmationModal = document.querySelector(`[data-modal-target="popup-modal_${commentId}"]`);
  //     confirmationModal.addEventListener('click', () => {
  //       const submitBtn = document.querySelector('[name="suppr_commentaire"]');
  //       submitBtn.value = commentId;
  //     });
  //   });
  // });
</script>

                <button data-modal-hide="popup-modal_" type="button" 
    ...
    <div class="relative w-full h-full max-w-2xl md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="staticModal2_">
       ...
       <div class="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600">
            ...
            <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                ...
                <button data-modal-hide="staticModal2_" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Annuler</button>
            </div>
        </div>
    </div>
</div>
...
<?php } ?>
  ...
  <!-- <script> const deleteBtns = document.querySelectorAll('[data-comment-id]');
deleteBtns.forEach(btn => {
  btn.addEventListener('click', (event) => {
