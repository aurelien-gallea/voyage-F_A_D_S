...
<body>
    ...
    >
      <div
        class="container flex flex-wrap items-center justify-between content-center mx-auto"
      >
        <a href="#" class="flex items-center pl-3">
          <img src="logo2.png" class="h-8 mr-4 sm:h-14" alt="TastyTrip" />
          <span
          ...
          >
            ...
            <li>
              <button
                ...
                class="flex items-center justify-between w-full py-3 pl-3 pr-4 font-medium text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-bg-custom-1C3738 md:p-0 md:w-auto dark:text-gray-400 dark:hover:text-white dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent"
              >
                Continents
                <svg
                  class="w-5 h-5 ml-1"
              ...
              <div
                id="dropdownNavbar"
                class="z-10 hidden font-normal bg-white opacity-85 divide-y divide-gray-100 rounded-lg shadow-xl w-44 dark:bg-gray-700 dark:divide-gray-600"
              >
                <ul
            ...
            <li>
              ...
              <div
                id="dropdownNavbar2"
                class="z-10 hidden font-normal bg-white opacity-89 divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600"
              >
                <ul
    ...
    <main>
      <section
        ...
        style="background-image: url(IMG_6466DONE3101.jpg)"
      ></section>
    </main>
