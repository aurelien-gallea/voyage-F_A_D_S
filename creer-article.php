...
<body class="bg-color-4 min-h-screen flex flex-col dark:bg-color-1">
		...
		<div class="mt-32 mb-10">
			...
			<div class="flex flex-col justify-center items-center">
				...
				<form method="POST" class="mt-5 w-3/6 mt-25 flex flex-col content-center justify-center bg-color-2 shadow-md rounded px-8 pt-6 pb-8 mb-4 dark:bg-gray-900 dark:border-gray-700">
					...
					<button id="dropdownSearchButton" data-dropdown-toggle="dropdownSearch" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-color-5 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-color-3 dark:focus:ring-blue-800" type="button">Catégories<svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
					...
					<br>
					<br>
					<input type="submit" value="Valider" class="bg-color-5 hover:bg-blue-700 dark:bg-color-3 text-white font-bold py-2 px-4 rounded" />
				</form>
			</div>
